...
public class CSharpExample : MonoBehaviour {
	...
	public static void Direct(MouseEvent mouseEvent){
		...
		Debug.Log("TagName = " + mouseEvent.htmlTarget.tagName);
		Debug.Log("NodeName = " + mouseEvent.htmlTarget.nodeName);
		Debug.Log("LocalName = " + mouseEvent.htmlTarget.localName);
		Debug.Log("ClassName = " + mouseEvent.htmlTarget.textContent);
	}
